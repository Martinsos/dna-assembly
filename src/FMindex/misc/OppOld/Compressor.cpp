...
void Compressor::initNOs(const string& L)
{
    ...
    cout << "velicina sb: " << sbNO.size() << endl;;
    cout << "velicina b: " << bNO.size() << endl;
}
...
string Compressor::getBWT(string& T)
{
    ...
    cout << "prosao mape, gotov BWT" << endl;
    int dummy;
    cin >> dummy;
...
{
    cout << "idem dobiti MTF" << endl;
    int dummy;
    cin >> dummy;
 
    vector< vector<char> > MTFPStates;
    int ukupno = 0;

    // Construct initial MTF list
    list<char> MTFList = alphabet.toSortedList();
    cout << "velicina pointera na listu charova je: " << sizeof(list<char>*) << endl;
    cout << "velicina abecede: " << MTFList.size() << endl;
    cout << "velicina pointera na char: " << sizeof(char*) << endl;

    cout << "velicina L-a: " << L.length() << endl;
    ...
    for (int i = 0; i < L.length(); i++)
    {
        ...
        if (i % bucketSize == 0) 
        {
            ...
            vector<char> MTFPicture(MTFList.begin(), MTFList.end());
            //MTFPStates.push_back(MTFPicture);
    ...
    cout << "dobio MTF" << endl;
    cout << "velicina MTFPStatesa: " << MTFPStates.size() << endl;
    cout << "kapacitet MTFPStatesa: " << MTFPStates.capacity() << endl;
    
    cout << "ukupni zbroj listi: " << ukupno << endl;
    cout << "velicina MTF-a: " << MTF.size() << endl;
