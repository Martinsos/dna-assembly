...
void RTQLEDA::build (const vector< pair<Index,Index> >& Q, const vector< pair<Index,Index> >& V)
{
...
vector< pair<Index,Index> > RTQLEDA::query(Index xMin, Index xMax, Index yMin, Index yMax)
{
